...
contract Market is ReentrancyGuard, Ownable {
 ...
 // this contract will have two prices, the listingFee and also a mintingFee...
  address payable holder;
  uint256 listingFee = 0.0025 ether;
  uint256 mintingFee = 0.0075 ether;

  // no parameter for the constructor function. 
...
// we are going to create a vault item that ask us for the addres of the nft contract, the token number of the nft, and the price for reselling the nft once minted
...
// is going to return all the items stored in the marketplace. but anything that is matching msg.sender this is my wallet. 
