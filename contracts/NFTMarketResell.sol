...
//(FUCKING CHANGE THE PRAGMA IN HARDHAT TOO!!!)
...
function listSale(uint tokenId, uint256 price) public payable nonReentrant {
    ...
    require (msg.value == listingFee, "Please transfer 0.0015 crypto to pay listing fee");
    _itemIds.increment();
...
function onERC721Received(
    ...
    require(from == address(0x0), "cannot send nfts to Valut directly ");
